...
public class ResultImpl implements ResultInterface{
	...
	@Override
	public void insertStudentResult(int totalquestionCount, int correctAnswerCount, int skippedQuestionCount,int wrongAnswerCount, int score, String grade,int studentId) {
		String query=null;
